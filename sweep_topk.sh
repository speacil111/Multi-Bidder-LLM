...
# =======================
TOP_K_1=(50 100 200 300 400 500 600 700 800)
TOP_K_2=(50 100 200 300 400 500 600 700 800)
...
run_dir="top_k_${BRAND_1}p${PROMPT_INDEX}_m2.25"
...
for top_k_2 in "${TOP_K_2[@]}"; do
  for top_k_1 in "${TOP_K_1[@]}"; do
    ...
    echo "[Run ${run_id}] ${BRAND_1}_top_k=${top_k_1}, ${BRAND_2}_top_k=${top_k_2}, ${BRAND_1}_multiplier=${MULTIPLIER_1}, ${BRAND_2}_multiplier=${MULTIPLIER_2}"
