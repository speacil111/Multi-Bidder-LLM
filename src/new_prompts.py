...
NEW_PROMPTS_DIVERSE = [
    ...
    # 距离 2：很近 (商务出行，关注常旅客计划、机房休息室与酒店升级)
    ...
    # 距离 5：中立/灰度 (已排除机票酒店预订，纯关注在地消费与预算分配)
    ...
    # 距离 6：较远 (数字游民的生活方式与工作效率，弱化“旅行”属性)
